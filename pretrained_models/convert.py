# This code is based on https://github.com/trueto/ERNIE2Torch
...
if not os.path.exists('ERNIE'):
    # Use reporo branch
    os.system('git clone -b repro https://github.com/PaddlePaddle/ERNIE/')
sys.path.append(str(REPO_DIR/ 'ERNIE' / 'ernie'))
try:
...
def save_model(args,state_dict, dump_path):
    ...
    with open(Path(args.init_pretraining_params).parent / "vocab.txt", "rt", encoding='utf-8') as f:
        for line in f:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--init_pretraining_params", default='./pretrained_models/ernie_2.0_skep_large_en/params/', type=str, help=".")
    parser.add_argument("--ernie_config_path", default='./pretrained_models/ernie_2.0_skep_large_en/ernie_config.json', type=str, help=".")
    parser.add_argument("--output_dir", default='./pretrained_models/ernie_2.0_skep_large_en_pytorch/', type=str, help=".")
